...
class RecruitmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Recruitment::insert(
            [
                [
                    'name' => "Computer Science", "departament" => "College of Natural Sciences", "description" => "(Some description in English)", "places" => "120", "amount" => "100", "start_date" => "2023-04-07", "end_date" => "2023-05-07"
                ],
                [
                    'name' => "Physics", "departament" => "College of Natural Sciences", "description" => "(Some description in English)", "places" => "80", "amount" => "70", "start_date" => "2023-04-07", "end_date" => "2023-05-07"
                ],
                [
                    'name' => "Chemistry", "departament" => "College of Natural Sciences", "description" => "(Some description in English)", "places" => "60", "amount" => "50", "start_date" => "2023-04-07", "end_date" => "2023-05-07"
                ],
                [
                    'name' => "Mathematics", "departament" => "College of Natural Sciences", "description" => "(Some description in English)", "places" => "90", "amount" => "80", "start_date" => "2023-04-07", "end_date" => "2023-05-07"
                ],
                [
                    'name' => "Biology", "departament" => "College of Natural Sciences", "description" => "(Some description in English)", "places" => "70", "amount" => "60", "start_date" => "2023-04-07", "end_date" => "2023-05-07"
                ],
                [
